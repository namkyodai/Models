data=read.csv("SA-sigmal.csv", header=T)
scalefactor=1000000
## add extra space to right margin of plot within frame
par(mar=c(5, 4, 4, 6) + 0.1)

## Plot first set of data and draw its axis
plot(data$sigmal, data$Extra, pch=2, axes=FALSE, ylim=c(10,20), xlab="", ylab="", 
...
plot(data$sigmal, data$Time, pch=4,  xlab="", ylab="", ylim=c(10,20), 
...
## Draw the time axis
axis(1,pretty(range(data$sigmal),10))
mtext(expression(paste("Standard deviation  ", sigma)),side=1,col="black",line=2.5)  
