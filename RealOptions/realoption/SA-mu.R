data=read.csv("SA-mu.csv", header=T)
scalefactor=1000000
## add extra space to right margin of plot within frame
par(mar=c(5, 4, 4, 6) + 0.1)

## Plot first set of data and draw its axis
plot(data$mu, data$Extra, pch=2, axes=FALSE, ylim=c(10,20), xlab="", ylab="", 
...
plot(data$mu, data$Time, pch=4,  xlab="", ylab="", ylim=c(10,20), 
...
## Draw the time axis
axis(1,pretty(range(data$mu),10))
mtext(expression(paste("Growth rate  ", mu)),side=1,col="black",line=2.5)  
