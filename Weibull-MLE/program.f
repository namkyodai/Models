...
*****************************************************************
	Module variable
	integer, parameter:: totaldata=15000
...
***********************************************************************	
	...
	real*8:: m, eps, obj, c1, c2, r, AIC, RSS
...
!	Defining the social cost, direct cost and the interest rate
	c1=5000000 ! this is social cost
	c2=1000000 ! this is direct repairing cost
	r=0.04 ! this is interest rate
	
!	STEP 1

	call step1(alpha,m,c1,c2,r)
...
!	call step2(alpha,m,c1,c2,r,lcc)
