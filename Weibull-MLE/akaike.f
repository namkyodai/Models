...
*****************************************************************
	Module variable
	integer, parameter:: totaldata=6060

	real(8), dimension(totaldata):: d, t, lcc
	integer, parameter:: timemax=1000000 !000000
	
	character(len=19), parameter:: file1="input\typeF.dat" !
...
!	real*8, dimension(2):: ts
	...
	alpha=2.55E-05 ! For F
	m=2.293


!	alpha=8.87E-05  For A
!	m=1.907
!	
	!---------------------------------------------

!	AKaike information cretiria (AIC), estimating log-likelihood value 
	...
	Print*, "Value of log-likelihood", rss
	close(10)
